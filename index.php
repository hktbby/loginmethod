...
?>
  ...
  <div class="container my-5">
        <h2 class="text-center">User Tenant Profiles</h2>
        <div class="card-container">
            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="card-text"><strong>Payment:</strong> <?php echo htmlspecialchars($rows['birthday']); ?></p>
                    <p class="card-text"><strong>sex:</strong> <?php echo htmlspecialchars($rows['sex']); ?></p>
                    <p class="card-text"><strong>Number:</strong> <?php echo htmlspecialchars($rows['Username']); ?></p>
                    <p class="card-text"><strong>Tenant Name:</strong> <?php echo ucwords(htmlspecialchars($rows['address'])); ?></p>
                    <form action="update.php" method="post" class="d-inline">
